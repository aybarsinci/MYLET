...
(check-run
 ...
 ;; calcHyp-exp basic tests
 (basic-hyp "calcNxEdge(5,12,90)" 13.0)
 (basic-hyp2 "calcNxEdge(3,4,90)" 5.0)
 (basic-hyp3 "calcNxEdge(4,4,90)" 5.656854249492381)
 (basic-hyp4 "calcNxEdge(12,16,48)" 19.457333337241167)
 (basic-hyp5 "calcNxEdge(41,32,134)" 52.43527568068443)
 
 ;; calcHyp-exp complex tests
 (complex-hyp "let x = 3 in let y = 4 in let deg = 90 in calcNxEdge(x,y,deg)" 5.0)
 (complex-hyp2 "calcNxEdge(op(6,'add',9),8,op(115,'sub',25))" 17.0)
 (complex-hyp3 "let a = op(7,'mult',5) in let b = op(139,'div',3) in let deg = op(45,'add',op(14,'add',23)) in calcNxEdge(a,b,deg)" 57.955854496522996)
